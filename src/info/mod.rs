...
pub fn get_flag<T: std::fmt::Display + serde::Serialize>(user: T) -> Option<String> {
...
pub fn get_original_ptid<T: std::fmt::Display + serde::Serialize>(user: T) -> Option<String> {
...
pub fn get_reason<T: std::fmt::Display + serde::Serialize>(user: T) -> Option<String> {
...
pub fn get_spam_predict<T: std::fmt::Display + serde::Serialize>(user: T) ->  Option<f64> {
    return full(user).results.spam_prediction.spam_prediction
}

pub fn get_ham_predict<T: std::fmt::Display + serde::Serialize>(user: T) -> Option<f64> {
    return full(user).results.spam_prediction.ham_prediction
}

pub fn get_lang<T: std::fmt::Display + serde::Serialize>(user: T) ->  Option<String> {
