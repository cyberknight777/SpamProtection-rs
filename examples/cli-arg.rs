...
fn main()
{
	...
	println!("Beware! This {} has a impersonation flag.", info::get_type(&arg));
    }

    if info::get_flag_massadd(&arg) {
	println!("Beware! This {} has a mass adding flag.", info::get_type(&arg));
    }
	...
	println!("Beware! This {} has a child abuse flag.", info::get_type(&arg));
    }
